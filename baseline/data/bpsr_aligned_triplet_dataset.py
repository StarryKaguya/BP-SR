...
class BPSRAlignedTripletDataset(data.Dataset):
    """Aligned triplet dataset for BPSR refinement.

    Read aligned `lq`, `diff`, and `gt` images for same-resolution refinement.
