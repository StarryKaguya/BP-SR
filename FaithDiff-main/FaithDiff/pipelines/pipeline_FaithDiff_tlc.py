    ...
    def encode_prompt(
        ...
        Args:
            ...
            prompt_embeds (`torch.FloatTensor`, *optional*):
                ...
                provided, text embeddings will be generated from `prompt` val2017 argument.
            negative_prompt_embeds (`torch.FloatTensor`, *optional*):
                Pre-generated negative text embeddings. Can be used to easily tweak text inputs, *e.g.* prompt
                weighting. If not provided, negative_prompt_embeds will be generated from `negative_prompt` val2017
                argument.
            pooled_prompt_embeds (`torch.FloatTensor`, *optional*):
                Pre-generated pooled text embeddings. Can be used to easily tweak text inputs, *e.g.* prompt weighting.
                If not provided, pooled text embeddings will be generated from `prompt` val2017 argument.
        ...
        if prompt_embeds is None:
            ...
            for prompt, tokenizer, text_encoder in zip(prompts, tokenizers, text_encoders):
                ...
                if untruncated_ids.shape[-1] >= text_input_ids.shape[-1] and not torch.equal(
                    ...
                    logger.warning(
                        "The following part of your val2017 was truncated because CLIP can only handle sequences up to"
        ...
        **kwargs,
        ...
        Args:
            ...
            negative_pooled_prompt_embeds (`torch.FloatTensor`, *optional*):
                ...
                weighting. If not provided, pooled negative_prompt_embeds will be generated from `negative_prompt`
                val2017 argument.
            ip_adapter_image: (`PipelineImageInput`, *optional*): Optional image val2017 to work with IP Adapters.
            ip_adapter_image_embeds (`List[torch.FloatTensor]`, *optional*):
                Pre-generated image embeddings for IP-Adapter. It should be a list of length same as number of
                IP-adapters. Each element should be a tensor of shape `(batch_size, num_images, emb_dim)`. It should
                contain the negative image embedding if `do_classifier_free_guidance` is set to `True`. If not
                provided, embeddings are computed from the `ip_adapter_image` val2017 argument.
        ...
        if callback is not None:
            deprecate(
                "callback",
                "1.0.0",
                "Passing `callback` as an val2017 argument to `__call__` is deprecated, consider use `callback_on_step_end`",
            )
        if callback_steps is not None:
            deprecate(
                "callback_steps",
                "1.0.0",
                "Passing `callback_steps` as an val2017 argument to `__call__` is deprecated, consider use `callback_on_step_end`",
            )
